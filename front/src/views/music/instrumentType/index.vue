            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    ...
                    <Form-item style="margin-left:10px;" class="br">
                        ...
                        <Button @click="add" type="info" size="small" icon="md-add" ghost v-show="$route.meta.permTypes.includes('add')">添加</Button>
                        <Button @click="delAll" type="error" icon="md-trash" size="small" ghost v-show="$route.meta.permTypes.includes('delete')">删除</Button>
...
export default {
                        ...
                        return h("div", [
                            ...
                            h(
                                "Button", {
                                    ...
                                    style: {
                                        "display": !(that.$route.meta.permTypes && that.$route.meta.permTypes.includes("delete")) ? "none" : ""
                                    },
                                    on: {
                                        click: () => {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getInstrumentTypeList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
